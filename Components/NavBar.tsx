...
dark:bg-green-700">
  ...
  <div className="flex md:order-2">
    ...
    className="md:hidden text-green-500 dark:text-green-400
     hover:bg-green-100 dark:hover:bg-cyan-50 
     focus:outline-none focus:ring-4 focus:ring-gray-200 
     dark:focus:ring-green-700 rounded-lg text-sm p-2.5 me-1 ">
    ...
    <div className="relative hidden md:block">
      ...
      border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500
       bg-dark-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Procurar..."/>
    </div>
      ...
      <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border
       border-gray-100 rounded-lg 
        ...
        md:flex-row md:mt-0 md:border-0 md:bg-white
         dark:bg-gray-950
         md:dark:bg-emerald-800 dark:border-emerald-800
         ">
        <li className="p-1">
